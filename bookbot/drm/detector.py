...
class DRMDetector:
    ...
    def detect_from_track(self, track: Track) -> DRMInfo:
        """
        Detect DRM from a Track instance.
        ...
        Returns:
            DRMInfo object with detection results
        """
        return self.detect_drm(track.src_path)
    ...
    def _extract_drm_metadata(
        self, file_path: Path, drm_type: DRMType
    ) -> dict[str, Any]:
